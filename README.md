...
- 1 AMQ instance (not ready for a AMQ mesh to simplify the example and avoid extra preparation steps such as providing view role to the XXXX service account)
